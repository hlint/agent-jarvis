/** biome-ignore-all lint/a11y/useAriaPropsForRole: <this is a input otp component> */
/** biome-ignore-all lint/a11y/useFocusableInteractive: <this is a input otp component> */
