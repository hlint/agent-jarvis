...
- Create tool call tasks to be executed in parallel. Each item: **toolName** and **brief** only—do NOT include input parameters.
...
- System hands control to tool call node; each tool's input parameters will be generated by a dedicated LLM
