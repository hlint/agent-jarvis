...
The outer think loop may continue with more internal steps after your message (e.g. tools or cleanup); that does not change your job here. Fulfill the [output instruction] completely and as if the user will read only this message for now. Do not refuse or shorten the reply because you assume the session is ending.
...
- Follow the [output instruction] for tone, scope, and structure.
